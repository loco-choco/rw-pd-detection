...
{
    /*class PDDetection : CosmeticSprite
    {
	...
	private bool parentFlipY;
        ...
        public PDDetection(GraphicsModule graphicsModule, int anchorSprite, float rotation, float headRadius, bool flip){
	    ...
	    sLeaser.sprites[0] = new FSprite("pd-detection");
